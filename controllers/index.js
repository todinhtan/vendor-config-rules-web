...
export async function saveRules(req, res) {
  ...
  if (req.body.byTag) {
    req.body.byTag.whiteList = req.body.byTag.whiteList ? req.body.byTag.whiteList.split(',') : [];
    req.body.byTag.blackList = req.body.byTag.blackList ? req.body.byTag.blackList.split(',') : [];
  }

  req.body.blockList = req.body.blockList ? req.body.blockList.split(',') : [];

  if (req.body.vendor) {
    req.body.vendor.whiteList = req.body.vendor.whiteList ? req.body.vendor.whiteList.split(',') : [];
    req.body.vendor.blackList = req.body.vendor.blackList ? req.body.vendor.blackList.split(',') : [];
  } 
